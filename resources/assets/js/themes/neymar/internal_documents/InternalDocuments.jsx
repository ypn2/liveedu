...
class InternalDocuments extends React.Component{
  ...
  render(){
    ...
    const drawer = (
      ...
      >
        <div className={classes.drawerHeader} style={{minHeight:42}}>
    ...
    return(
        <div className={classes.appFrame}>
          ...
          >
            <Toolbar disableGutters={!open} style={{minHeight:47}}>
              <IconButton
                color="inherit"
...
export default withStyles(styles, { withTheme: true })(InternalDocuments);
